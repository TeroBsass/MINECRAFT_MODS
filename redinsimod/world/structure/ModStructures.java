...
public class ModStructures {
    public static final DeferredRegister<Structure<?>> STRUCTURES =
            DeferredRegister.create(ForgeRegistries.STRUCTURE_FEATURES, RedinsiMod.MOD_ID);

    public static final RegistryObject<Structure<NoFeatureConfig>> HOUSE =
            STRUCTURES.register("house", HouseStructure::new);

    public static final RegistryObject<Structure<NoFeatureConfig>> HOUSE_TWO =
            STRUCTURES.register("house_2", HouseStructureTwo::new);
    ...
    public static void setupStructures() {
        setupMapSpacingAndLand(HOUSE.get(),
                ...
                true);
        setupMapSpacingAndLand(HOUSE_TWO.get(),
                new StructureSeparationSettings(100, 50, 1234567890),
                true);
    }
