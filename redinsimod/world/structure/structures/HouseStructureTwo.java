...
public class HouseStructureTwo extends Structure<NoFeatureConfig> {
    public HouseStructureTwo() {
    ...
    public IStartFactory<NoFeatureConfig> getStartFactory() {
        return HouseStructureTwo.Start::new;
    }
        ...
        public void func_230364_a_(DynamicRegistries dynamicRegistryManager,
            ...
            JigsawManager.func_242837_a(dynamicRegistryManager,
                    new VillageConfig(() -> dynamicRegistryManager.getRegistry(Registry.JIGSAW_POOL_KEY)
                            .getOrDefault(new ResourceLocation(RedinsiMod.MOD_ID, "house_2/start_pool")),
                            10), AbstractVillagePiece::new, chunkGenerator, templateManagerIn,
                    blockpos, this.components, this.rand,false,true);
            this.components.forEach(piece -> piece.offset(0, 1, 0));
            this.components.forEach(piece -> piece.getBoundingBox().minY -= 1);
            this.recalculateStructureSize();
            LogManager.getLogger().log(Level.DEBUG, "House_two at " +
