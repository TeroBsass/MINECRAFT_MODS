package net.redinsi.redinsimod.world;
...
import net.redinsi.redinsimod.world.gen.ModStructureGeneration;
...
@Mod.EventBusSubscriber(modid = RedinsiMod.MOD_ID)
public class ModWorldEvents {
    ...
    public static void addDimensionalSpacing(final WorldEvent.Load event) {
        if(event.getWorld() instanceof ServerWorld) {
            ...
            tempMap.putIfAbsent(ModStructures.HOUSE_TWO.get(),
                    DimensionStructuresSettings.field_236191_b_.get(ModStructures.HOUSE_TWO.get()));
