...
public class MethCookContainer extends Container {
    private final TileEntity tileEntity;
    private final PlayerEntity playerEntity;
    private final IItemHandler inventory;

    public MethCookContainer(int windowId, World world, BlockPos pos,
                             PlayerInventory playerInventory, PlayerEntity player) {
        super(ModContainers.METH_COOK_CONTAINER.get(), windowId);
    ...
    public boolean isMethCookingStorm() {
    ...
    // For this container, we can see both the tile inventory's slots awa the player inventory slots and the hotbar.
